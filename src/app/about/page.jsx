        ...
        <>
          <div className={styles.main} >
            ...
            <div className={styles.div}>
                ...
                <Image src={Tec1} className={styles.parrafo} />
            </div>
            ...
            <div className={styles.div2}>
                ...
                <Image src={Tec2} className={styles.parrafo} />
            </div>
            ...
            <div className={styles.div}>
                ...
                <Image src={Tec3} className={styles.parrafo} />
            </div>
            ...
            <div className={styles.div2}>
                ...
                <Image src={Tec4} className={styles.parrafo} />
            </div>
